        ...
        try (Scanner inputan = new Scanner(System.in)) {
            ...
            if (input_username.equalsIgnoreCase("Kereta Yogyakarta") && input_password.equalsIgnoreCase("123456")) {
                ...
                do {
                    ...
                    switch (angka) {
                        case 1:
                            System.out.println("Mengisikan Tiket yang Tersedia");
                            System.out.println("------------------------------");
                            // stack
                            for (int i = 1; i <= 10; i++) {
                                bisnis.push(i);
                                ...
                                if (no_antrian.isEmpty() == false) {
                                    ...
                                    switch (jawaban_4) {
                                        case 1:
                                            ...
                                            System.out.println("silahkan lakukan pembayaran " + harga_bisnis + " : ");
                                            System.out.println("-------------------------------");
                                            uang_bayar = inputan.nextInt();
                                            if (uang_bayar > harga_bisnis) {
                                                kembalian = uang_bayar - harga_bisnis;
                                                System.out.println("Terimakasih, kembalian anda adalah : " + kembalian);
                                        ...
                                        case 2:
                                            ...
                                            // add binary tree
                                            kereta.addNode(new Node(umur));
                                            System.out.println("silahkan lakukan pembayaran " + harga_ekonomi + " : ");
                                            System.out.println("-------------------------------");
                                            uang_bayar = inputan.nextInt();
